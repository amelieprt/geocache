...
app.get('/delete-user', (req, res) => {
    res.sendFile(path_1.default.join(__dirname, '../public/delete-user.html'));
});
// route pour servir le formulaire de mise à jour d'utilisateur
app.get('/update-user', (req, res) => {
    res.sendFile(path_1.default.join(__dirname, '../public/update-user.html'));
});
app.get('/read-user', (req, res) => {
    res.sendFile(path_1.default.join(__dirname, '../public/read-user.html'));
});
///////////// CACHETTE FORMULAIRE /////////////
// route pour servir le formulaire de création de cachette
app.get('/create-cachette', (req, res) => {
    res.sendFile(path_1.default.join(__dirname, '../public/create-cachette.html'));
});
...
app.get('/delete-cachette', (req, res) => {
    res.sendFile(path_1.default.join(__dirname, '../public/delete-cachette.html'));
});
// route pour servir le formulaire de mise à jour de cachette
app.get('/update-cachette', (req, res) => {
    res.sendFile(path_1.default.join(__dirname, '../public/update-cachette.html'));
});
//////////////////////////USERS////////////////////////////
app.use(express_1.default.json());
app.use(express_1.default.urlencoded({ extended: true }));
